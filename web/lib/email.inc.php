 ...
 * Copyright (C) 2004-2005, Three Wise Men Inc.
 *
...
define("TWM_MAIL_DEFAULTSENDER", "ETI Coordinator <bmacneil@etitechnologies.com>");
define("TWM_MAIL_DEFAULTSUBJECT", "ETI Technologies Fundraising Program");
